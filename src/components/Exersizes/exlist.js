...
export const exersizes = [
  ...
  },
  {
    ...
    element: (
      <div>
        <MathJax
          math="Автобус движется со скоростью 54 `км/ч`. На каком расстоянии от остановки
  ...
  },
  {
    ...
    element: (
      <div>
        <MathJax math="Два автомобиля выезжают из одного пункта в одном направлении. Первый автомобиль выезжает на 20 с позже другого. Оба движуться с одинаковым ускорением, равным `0,4 м/с^2`. Через сколько времени, считая от начала движения первого автомобиля, расстояние между ними окажеться равным 240м?" />
      </div>
    ),
  },
  {
